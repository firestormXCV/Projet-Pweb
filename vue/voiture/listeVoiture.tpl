...
<head>
    ...
    <![endif]-->       
    <link rel="shortcut icon" href="vue/images/ico/favicon.ico">
    ...
    <link rel="apple-touch-icon-precomposed" href="vue/images/ico/apple-touch-icon-57-precomposed.png">
</head><!--/head-->
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Voitures Disponibles</h2>
